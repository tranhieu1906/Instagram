    ...
    <div className="hidden sm:flex flex-col border-r w-1/4">
      ...
      <div className="flex border-t mt-12 flex-col gap-2 p-6">
        ...
        <p className="text-xs text-gray-400">
          Kiểm soát chế độ cài đặt khi kết nối các trải nghiệm trên Instagram,
          ứng dụng Facebook và Messenger, bao gồm tính năng chia sẻ tin, bài
          viết và đăng nhập.
        </p>
      </div>
    </div>
